...
void CreateUnitLayer::set(TMXTiledMap * AM,Layer * AL, EventListenerTouchOneByOne * ALis)
{
	addMap = AM;
	addLayer = AL;
...
{
	CreateUnitLayer::set(AM,AL,ALis);
	realInit();
}
//type为1的兵营弹出的菜单
